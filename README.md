...
手動実行が成功したら、dbt Cloud の Orchestration で Environment を作成し、Deploy Job で Daily 実行を設定します。詳細は [HANDSON_STEPS.md](HANDSON_STEPS.md) の Environment / Daily Job 設定手順を参照してください。
